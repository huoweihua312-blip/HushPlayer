...
def manifest_document(
    ...
    setup: bytes,
    *,
    version: str = "0.5.0-beta.3",
    numeric_version: str = "0.5.0.3",
...
def parser_checks(setup: bytes) -> None:
    ...
    assert manifest.numeric_version == (0, 5, 0, 3)
    assert manifest.installer_filename == "HushPlayer-0.5.0-beta.3-win-x64-setup.exe"

    same = dict(valid, version="0.5.0-beta.2", numeric_version="0.5.0.2")
    old = dict(valid, version="0.5.0-beta.1", numeric_version="0.5.0.1")
    ...
    assert_manifest_rejected(
        dict(valid, numeric_version="0.5.0.4"),
