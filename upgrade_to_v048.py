...
def main() -> None:
    ...
    def __init__(self, main_window) -> None:
        ...
        self.setStyleSheet(
            '''
            QWidget#immersiveLyricsWindow {
                background: #050609;
                color: #ffffff;
                font-family: "Microsoft YaHei UI";
            }

            QLabel#immersiveSongTitle {
                color: #ffffff;
                font-size: 30px;
                font-weight: 900;
            }

            QLabel#immersiveSongArtist {
                color: #aab1bf;
                font-size: 15px;
            }

            QLabel#immersiveStatus {
                color: #667085;
                font-size: 12px;
            }

            QLabel#immersiveFooter {
                color: #555e6d;
                font-size: 12px;
            }

            QPushButton#immersiveButton {
                background: #1f232c;
                color: #dfe3ec;
                border: none;
                border-radius: 12px;
            ...
            QPushButton#immersiveButton:hover {
                background: #2f68d8;
                color: #ffffff;
            }

            QScrollArea#immersiveLyricsView,
