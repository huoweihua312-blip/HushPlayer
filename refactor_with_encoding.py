# -*- coding: utf-8 -*-
"""Refactor settings_dialog.py with proper UTF-8 handling"""

import subprocess
from pathlib import Path

# Step 1: Get original file from git with correct encoding
result = subprocess.run(['git', 'show', 'HEAD:app/ui/settings_dialog.py'],
                       capture_output=True, check=True)

# Decode from UTF-8
original_content = result.stdout.decode('utf-8')
lines = original_content.split('\n')

print(f"Original file: {len(lines)} lines")

# Find insertion point (where appearance_card starts)
insert_point = None
...
# New code with all page initialization methods
new_code_lines = [
    '',
    '        # Connect navigation',
...
# Combine all parts
result_lines = header + new_code_lines + footer
result_content = '\n'.join(result_lines)

# Write with UTF-8 encoding
with open('app/ui/settings_dialog.py', 'w', encoding='utf-8') as f:
    f.write(result_content)

print(f"Refactored! New file has {len(result_lines)} lines")
