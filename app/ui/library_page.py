...
class LibraryPage(QFrame):
    ...
    def _build_ui(self) -> None:
        ...
        random_button = QPushButton("随机播放")
        random_button.setObjectName("secondaryButton")
        random_button.setCursor(Qt.CursorShape.PointingHandCursor)
        random_button.clicked.connect(self.randomPlayRequested)
        more_button = QPushButton("更多")
        more_button.setObjectName("secondaryButton")
        ...
        folder_button.clicked.connect(self.importFolderRequested)
        import_button = QPushButton("导入音乐")
        import_button.setObjectName("primaryButton")
        import_button.setCursor(Qt.CursorShape.PointingHandCursor)
        import_button.clicked.connect(self.importFilesRequested)
