...
from PySide6.QtCore import QItemSelectionModel, QModelIndex, QRectF, QSignalBlocker, Qt, Signal
...
class TrackTable(QTableView):
    ...
    def __init__(self, adapter: LibraryAdapter, theme: Theme, parent: QWidget | None = None) -> None:
        ...
        self.verticalHeader().setMinimumSectionSize(theme.metrics.track_row_height)
